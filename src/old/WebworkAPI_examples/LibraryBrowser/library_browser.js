...
$(function () {
    ...
    //collection, el, jQuery(style, data-path, data-source, draggable, tabs, sortable, droppable), remove_display, cardcatalog***
    //NOTE: some elements above are  from jQueryUI API
    ...
    var ProblemView = Backbone.View.extend({
        ...
        initialize: function () {            
            ...
            if(!this.options.remove_display){   //does it make sense?????????????
        ...
        render:function () {
            ...
            var self = this;
            //if problem.data evaluates to true, build view html and draggable
            if (problem.get('data')) {
                //copy model attributes into an object
            ...
            //Manipulating DOM attributes. Working on a jQuery wrap might a better idea
        ...
        clear: function(){
            ...
            this.model.clear(); //automatically fires this.render()
        }
    });
    ...
    var LibraryListView = Backbone.View.extend({
        ...
        events: {
            //'change .list': 'lib_selected'    //this may need to opened?????????
        },
        ...
        initialize:function () {
            ...
            //what does it mean?????????? is this.model a collection?
        ...
        render:function () {
            ...
            //**this is probably where library is selected**
    ...
    var SetListView = Backbone.View.extend({
        ...
        render:function () {
            ...
            self.$el.html(self.template()); //no arguments for template?????????
    ...
    var LibraryBrowser = Backbone.View.extend({
        ...
        initialize:function () {
            ...
            //callback if ajax request fails
        ...
        //no undo_stack and no redo_stack?????????????????????
        undo:function () {
